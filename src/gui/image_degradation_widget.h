...
#ifndef SRC_GUI_IMAGE_DEGRADATION_WIDGET_H_
#define SRC_GUI_IMAGE_DEGRADATION_WIDGET_H_

#include <QWidget>

namespace hsi_data_generator {

class ImageDegradationWidget : public QWidget {
  // TODO: Implement this widget.
};

}  // namespace hsi_data_generator

#endif  // SRC_GUI_IMAGE_DEGRADATION_WIDGET_H_
